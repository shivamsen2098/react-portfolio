  ...
  return (
    <header className="bg-gray-900 text-white fixed w-full z-50 shadow-md">
      <div className="container mx-auto px-6 py-4 flex justify-between items-center">
        ...
        >
          <li><a href="#home" className="block py-2 px-4 hover:text-cyan-400">Home</a></li>
          <li><a href="#about" className="block py-2 px-4 hover:text-cyan-400">About</a></li>
          <li><a href="#skills" className="block py-2 px-4 hover:text-cyan-400">Skills</a></li>
          <li><a href="#portfolio" className="block py-2 px-4 hover:text-cyan-400">Projects</a></li>
          <li><a href="#services" className="block py-2 px-4 hover:text-cyan-400">Services</a></li>
