                    ...
                    <div className="flex flex-col lg:flex-row gap-16">
                        ...
                        <div className="lg:w-1/2 space-y-8 text-gray-700 dark:text-gray-300">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4 group">
                                    <div className="bg-gradient-to-r from-pink-500 to-red-500 p-3 rounded-full shadow-lg group-hover:scale-110 transition-transform duration-300">
                                        <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div className="flex gap-6 mt-10">
                                <a href="#" className="bg-gradient-to-r from-blue-500 to-blue-600 p-4 rounded-full text-white shadow-lg hover:scale-110 transition-all duration-300 hover:shadow-blue-500/50">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                                    </svg>
                                </a>
                                <a href="#" className="bg-gradient-to-r from-gray-700 to-gray-800 p-4 rounded-full text-white shadow-lg hover:scale-110 transition-all duration-300 hover:shadow-gray-500/50">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
